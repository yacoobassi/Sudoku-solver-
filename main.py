...
total = ["python", sendFile, "-p",port, "-f", "gcodes/total.gcode", "-r", "1", "-v", "1"]
...
def merge_gcode_files(file1, file2, output_file):
    try:
   ...
   # subprocess.run(start)
    for count_col in range(9):
        for count_row in range(9):
            ...
            if col==9:
                break
            gcode_file=num_to_gcode_list.get(two_dim_matrix[row][col])
            merge_gcode_files("gcodes/total.gcode", gcode_file, "gcodes/total.gcode")

            if direction==1:
                if row==8:           
                    merge_gcode_files("gcodes/total.gcode", "gcodes/up.gcode","gcodes/total.gcode")
                else:
                    merge_gcode_files("gcodes/total.gcode", "gcodes/right.gcode", "gcodes/total.gcode")
                   
            else:
                 if row==0:
                     merge_gcode_files("gcodes/total.gcode", "gcodes/up.gcode", "gcodes/total.gcode")
                 else:
                     merge_gcode_files("gcodes/total.gcode", "gcodes/left.gcode", "gcodes/total.gcode")
...
>>> %Run main.py
2023-09-01 14:40:28.369945: W tensorflow/tsl/framework/cpu_allocator_impl.cc:83] Allocation of 8667136 exceeds 10% of free system memory.
2023-09-01 14:40:28.484581: W tensorflow/tsl/framework/cpu_allocator_impl.cc:83] Allocation of 15859712 exceeds 10% of free system memory.
2023-09-01 14:40:28.984276: W tensorflow/tsl/framework/cpu_allocator_impl.cc:83] Allocation of 3612672 exceeds 10% of free system memory.
2023-09-01 14:40:29.187633: W tensorflow/tsl/framework/cpu_allocator_impl.cc:83] Allocation of 5914624 exceeds 10% of free system memory.
2023-09-01 14:40:29.457925: W tensorflow/tsl/framework/cpu_allocator_impl.cc:83] Allocation of 4734976 exceeds 10% of free system memory.
3/3 [==============================] - 7s 1s/step
Traceback (most recent call last):
  File "/home/obaida/Desktop/MohammadProject/main.py", line 255, in <module>
    move()
  File "/home/obaida/Desktop/MohammadProject/main.py", line 104, in move
    merge_gcode_files("gcodes/total.gcode", gcode_file, "gcodes/total.gcode")
  File "/home/obaida/Desktop/MohammadProject/main.py", line 74, in merge_gcode_files
    with open(file1, 'r') as f1, open(file2, 'r') as f2, open(output_file, 'w') as out:
